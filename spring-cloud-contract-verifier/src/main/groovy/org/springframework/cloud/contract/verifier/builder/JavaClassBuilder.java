 ...
 * @since 2.2.0
 */
class JavaClassBuilder implements ClassBuilder, DefaultClassBuilder {
	...
	private JavaClassBuilder(DefaultClassMetadata metaData) {
		this.metaData = metaData;
	}

	public static JavaClassBuilder builder(DefaultClassMetadata metaData) {
		return new JavaClassBuilder(metaData);
	}
