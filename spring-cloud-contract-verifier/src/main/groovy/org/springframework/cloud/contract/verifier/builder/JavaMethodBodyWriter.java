...
/**
 * Writes the method body, with Java specific differences.
 *
 * @author Tim Ysewyn
 * @since 2.2.0
 */
class JavaMethodBodyWriter implements MethodBodyWriter, DefaultMethodBodyWriter {

	private final BlockBuilder blockBuilder;

	JavaMethodBodyWriter(BlockBuilder blockBuilder) {
	...
	@Override
	public MethodBodyWriter addEndingIfNotPresent() {
